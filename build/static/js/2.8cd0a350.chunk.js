            ...
            (function (n) {
                ...
                !(function () {
                    ...
                    r.prototype = {
                            ...
                            if (
                                ...
                                for (var n = 0; n < t._howls.length; n++)
                                    if (!t._howls[n]._webAudio)
                                        for (
                                            var o = t._howls[n]._getSoundIds(),
                                                r = 0;
                                            r < o.length;
                                            r++
                                        ) {
                                            var a = t._howls[n]._soundById(
                                                o[r]
                                            );
                                            a &&
                                                a._node &&
                        ...
                        unload: function () {
                            for (
                                var e = this || i, t = e._howls.length - 1;
                                t >= 0;
                                t--
                            )
                                e._howls[t].unload();
                    ...
                    a.prototype = {
                        ...
                        play: function (e, t) {
                            ...
                            if (o && !s._paused)
                                return t || n._loadQueue('play'), s._id;
                            ...
                            var d = Math.max(
                                ...
                                _ = Math.max(
                                    0,
                                    (n._sprite[e][0] + n._sprite[e][1]) / 1e3 -
                                        d
                                ),
                                ...
                                if (n._webAudio) {
                                    var m = function () {
                                        ...
                                        h.gain.setValueAtTime(
                                            ...
                                            'undefined' ===
                                            typeof h.bufferSource.start
                                                ? s._loop
                                                    ? h.bufferSource.noteGrainOn(
                                                          0,
                                                          d,
                                                          86400
                                                      )
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    if (t._webAudio) {
                                        ...
                                        'undefined' ===
                                        typeof r._node.bufferSource.stop
                                    ...
                                    i._node &&
                                        (n._webAudio
                                            ? i._node.bufferSource &&
                                              ('undefined' ===
                                              typeof i._node.bufferSource.stop
                                                  ? i._node.bufferSource.noteOff(
                                                        0
                                                    )
                                                  : i._node.bufferSource.stop(
                                                        0
                                                    ),
                            ...
                            for (var a = 0; a < t.length; a++)
                                (n = o._soundById(t[a])) &&
                                    ...
                                    o._webAudio && n._node && !n._muted
                                        ? n._node.gain.setValueAtTime(
                                              e,
                                              i.ctx.currentTime
                                          )
                                        : n._node &&
                                          !n._muted &&
                                          (n._node.volume = e * i.volume()),
                        ...
                        fade: function (e, t, n, o) {
                            ...
                            for (
                                ...
                                if (u) {
                                    if (
                                        (o || r._stopFade(a[s]),
                                        r._webAudio && !u._muted)
                                    ) {
                                        var d = i.ctx.currentTime,
                                            _ = d + n / 1e3;
                                        (u._volume = e),
                                            u._node.gain.setValueAtTime(e, d),
                                            u._node.gain.linearRampToValueAtTime(
                                                t,
                                                _
                                            );
                                    }
                            ...
                            for (var a = 0; a < t.length; a++)
                                if ((n = o._soundById(t[a]))) {
                                    ...
                                    var s = o.seek(t[a]),
                                        u =
                                            (1e3 *
                                                ((o._sprite[n._sprite][0] +
                                                    o._sprite[n._sprite][1]) /
                                                    1e3 -
                                                    s)) /
                                            Math.abs(n._rate);
                                    (!o._endTimers[t[a]] && n._paused) ||
                                        (o._clearTimer(t[a]),
                                        (o._endTimers[t[a]] = setTimeout(
                                            o._ended.bind(o, n),
                                            u
                                        ))),
                                        o._emit('rate', n._id);
                        ...
                        duration: function (e) {
                            var t = this._duration,
                                n = this._soundById(e);
                            return (
                                n && (t = this._sprite[n._sprite][1] / 1e3), t
                            );
                        },
                        state: function () {
                            return this._state;
                        ...
                        _cleanBuffer: function (e) {
                            var t =
                                i._navigator &&
                                i._navigator.vendor.indexOf('Apple') >= 0;
                            if (
                                i._scratchBuffer &&
                                e.bufferSource &&
                            ...
                            return (
                                e._webAudio
                                    ...
                                    : i.noAudio ||
                                      ...
                                      (this._errorFn = this._errorListener.bind(
                                          this
                                      )),
                                      ...
                                      (this._loadFn = this._loadListener.bind(
                                          this
                                      )),
                                      this._node.addEventListener(
                                          i._canPlayEvent,
                                      ...
                                      (this._endFn = this._endListener.bind(
                                          this
                                      )),
                                      this._node.addEventListener(
                                          'ended',
                    ...
                    var u = {},
                        d = function (e) {
                            var t = e._src;
                            if (u[t])
                                return (e._duration = u[t].duration), void c(e);
                        ...
                        p = function () {
                            if (i.usingWebAudio) {
                                ...
                                if (e && n && n < 9) {
                                    var o = /safari/.test(
                                        i._navigator &&
                                            i._navigator.userAgent.toLowerCase()
                                    );
                                    i._navigator &&
                                        !o &&
                                        (i.usingWebAudio = !1);
                    ...
                    (function () {
                        ...
                        (HowlerGlobal.prototype._pos = [0, 0, 0]),
                                ...
                                return this.ctx && this.ctx.listener
                                    ? ((t =
                                      ...
                                      'number' !== typeof e
                                          ...
                                          : ((this._pos = [e, t, n]),
                                            'undefined' !==
                                            typeof this.ctx.listener.positionX
                                ...
                                return (
                                    ...
                                    'number' !== typeof e
                                        ...
                                        : ((this._orientation = [
                                          ...
                                          'undefined' !==
                                          typeof this.ctx.listener.forwardX
                                ...
                                function (t) {
                                    return (
                                        ...
                                        (this._pannerAttr = {
                                            coneInnerAngle:
                                                'undefined' !==
                                                typeof t.coneInnerAngle
                                                    ? t.coneInnerAngle
                                                    : 360,
                                            coneOuterAngle:
                                                'undefined' !==
                                                typeof t.coneOuterAngle
                                                    ? t.coneOuterAngle
                                                    : 360,
                                            coneOuterGain:
                                                'undefined' !==
                                                typeof t.coneOuterGain
                                                    ? t.coneOuterGain
                                                    : 0,
                                            distanceModel:
                                                'undefined' !==
                                                typeof t.distanceModel
                                                    ? t.distanceModel
                                                    : 'inverse',
                                            maxDistance:
                                                'undefined' !==
                                                typeof t.maxDistance
                                                    ? t.maxDistance
                                                    : 1e4,
                                            panningModel:
                                                'undefined' !==
                                                typeof t.panningModel
                                                    ? t.panningModel
                                                    : 'HRTF',
                                            refDistance:
                                                'undefined' !==
                                                typeof t.refDistance
                                                    ? t.refDistance
                                                    : 1,
                                            rolloffFactor:
                                                'undefined' !==
                                                typeof t.rolloffFactor
                                                    ? t.rolloffFactor
                                                    : 1,
                                        }),
                            ...
                            (Howl.prototype.stereo = function (e, n) {
                                ...
                                var r =
                                    'undefined' ===
                                    typeof Howler.ctx.createStereoPanner
                                        ? 'spatial'
                                        : 'stereo';
                                ...
                                for (
                                    ...
                                    if (s) {
                                        ...
                                        (s._stereo = e),
                                            (s._pos = [e, 0, 0]),
                                            s._node &&
                                                ((s._pannerAttr.panningModel =
                                                    'equalpower'),
                                                (s._panner && s._panner.pan) ||
                                                    t(s, r),
                                                'spatial' === r
                                                    ? 'undefined' !==
                                                      typeof s._panner.positionX
                                ...
                                for (
                                    ...
                                    if ((o = this._soundById(i[a]))) {
                                        ...
                                        s = {
                                            coneInnerAngle:
                                                'undefined' !==
                                                typeof e.coneInnerAngle
                                                    ? e.coneInnerAngle
                                                    : s.coneInnerAngle,
                                            coneOuterAngle:
                                                'undefined' !==
                                                typeof e.coneOuterAngle
                                                    ? e.coneOuterAngle
                                                    : s.coneOuterAngle,
                                            coneOuterGain:
                                                'undefined' !==
                                                typeof e.coneOuterGain
                                                    ? e.coneOuterGain
                                                    : s.coneOuterGain,
                                            distanceModel:
                                                'undefined' !==
                                                typeof e.distanceModel
                                                    ? e.distanceModel
                                                    : s.distanceModel,
                                            maxDistance:
                                                'undefined' !==
                                                typeof e.maxDistance
                                                    ? e.maxDistance
                                                    : s.maxDistance,
                                            refDistance:
                                                'undefined' !==
                                                typeof e.refDistance
                                                    ? e.refDistance
                                                    : s.refDistance,
                                            rolloffFactor:
                                                'undefined' !==
                                                typeof e.rolloffFactor
                                                    ? e.rolloffFactor
                                                    : s.rolloffFactor,
                                            panningModel:
                                                'undefined' !==
                                                typeof e.panningModel
                                                    ? e.panningModel
                                                    : s.panningModel,
                                        };
                                        var u = o._panner;
...
//# sourceMappingURL=2.8cd0a350.chunk.js.map
